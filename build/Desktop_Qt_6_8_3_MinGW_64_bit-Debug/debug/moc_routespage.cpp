...
static constexpr auto qt_meta_stringdata_ZN10RoutesPageE = QtMocHelpers::stringData(
    "RoutesPage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10RoutesPageE[] = {
...
Q_CONSTINIT const QMetaObject RoutesPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10RoutesPageE.offsetsAndSizes,
    qt_meta_data_ZN10RoutesPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10RoutesPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *RoutesPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10RoutesPageE.stringdata0))
